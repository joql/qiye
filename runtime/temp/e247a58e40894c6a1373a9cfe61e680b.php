<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"E:\code\qiye\public/../application/admin\view\index\index.html";i:1503976960;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                    ...
                    <ul class="layui-nav" lay-filter="">
                      ...
                      <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child"> <!-- 二级菜单 -->
                          <dd><a href="">个人信息</a></dd>
                          <dd><a href="">切换帐号</a></dd>
                          <dd><a href="__STATIC__/login.html">退出</a></dd>
                        </dl>
                      </li>
                      <!-- <li class="layui-nav-item">
                        <a href="" title="消息">
                    ...
                    <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="__STATIC__/banner-list.html">
                                            <cite>轮播列表</cite>
                                        </a>
                                    </dd>
                                </dd>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/member-del.html">
                                        <cite>删除会员</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/member-level.html">
                                        <cite>等级管理</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/member-kiss.html">
                                        <cite>积分管理</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/member-view.html">
                                        <cite>浏览记录</cite>
                                    </a>
                                </dd>
                                <dd class="">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/admin-list.html">
                                        <cite>管理员列表</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/admin-role.html">
                                        <cite>角色管理</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/admin-cate.html">
                                        <cite>权限分类</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/admin-rule.html">
                                        <cite>权限管理</cite>
                                    </a>
                                </dd>
                            </dl>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/echarts1.html">
                                        <cite>拆线图</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/echarts2.html">
                                        <cite>柱状图</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/echarts3.html">
                                        <cite>地图</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/echarts4.html">
                                        <cite>饼图</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/echarts5.html">
                                        <cite>雷达图</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/echarts6.html">
                                        <cite>k线图</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/echarts7.html">
                                        <cite>热力图</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/echarts8.html">
                                        <cite>仪表图</cite>
                                    </a>
                                </dd>
                                <dd class="">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/sys-set.html">
                                        <cite>系统设置</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/sys-data.html">
                                        <cite>数字字典</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/sys-shield.html">
                                        <cite>屏蔽词</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/sys-log.html">
                                        <cite>系统日志</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/sys-link.html">
                                        <cite>友情链接</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="__STATIC__/sys-qq.html">
                                        <cite>第三方登录</cite>
                                    </a>
                                </dd>
                            </dl>
